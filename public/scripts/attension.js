...
function callProfileEdit() {
    attensionCencel();
    let attension = window.document.querySelector("#attension");
    attension.style.display = "flex";
    let edit_profile = window.document.querySelector("#edit_profile");
    edit_profile.style.display = "flex";
    edit_profile.querySelector("#input_nickname").value = private_accaunt_data.nickname;
    // edit_profile.querySelector("#locked_nickname").innerHTML = private_accaunt_data.nickname;
...
function attensionCencel() {
    ...
    window.document.querySelector("#save_error_message").style.display = "none";
...
// window.document.querySelectorAll(".user-avatar").forEach((i) => {
//     i.addEventListener("click", callProfileEdit)
// });
