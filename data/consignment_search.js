...
class consignmentSearch {
    ...
    checkPossiblePair(consignments_array, io, login_sockets, data_manager) {
    ...
    acceptGame(login, io, login_sockets, consignment_plays) {
        ...
        if (find[0]) {
            ...
            if (this.consignmentsWaitForAccept[index].accept_status[0] && this.consignmentsWaitForAccept[index].accept_status[1]) {
                ...
                this.startGame(login1, login2, mode, is_ranked, io, login_sockets, consignment_plays);
    ...
    startGame(login1, login2, mode, is_ranked, io, login_sockets, consignment_plays) {
